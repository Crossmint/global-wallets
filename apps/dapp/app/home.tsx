    ...
    return (
      <div className="flex flex-col gap-4 justify-center items-center">
        <Image
          ...
          height={150}
        />
        <h1 className="text-xl font-medium">EVM Wallets Quickstart</h1>
    ...
    <div className="w-full max-w-6xl mx-auto px-4 py-6 sm:py-8">
      <div className="flex flex-col mb-8">
        <Image
          ...
          className="mb-4"
        />
        <h1 className="text-2xl font-semibold mb-2">DApp</h1>
        <p className="text-gray-600 text-sm">DApp Wallet</p>
      </div>
